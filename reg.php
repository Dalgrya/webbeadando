...
<div class="container">
        ...
        <form action="./regUsers.php" method="post">
            ...
            <input name="username" type="username" class="form-control" placeholder="dickmaster" aria-label="Username" aria-describedby="basic-addon1">
            <label>Email:</label>
            <input name="name" type="email" class="form-control" placeholder="proba@proba.hu" aria-label="Username" aria-describedby="basic-addon1">
            <label> Jelszó:</label>
